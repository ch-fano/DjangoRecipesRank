"""
Django settings for DjangoRecipesRank project.
...
SECRET_KEY = 'django-insecure-+5qeg%asl(@u-ep1+h1p8pi%@ybayci7$wve2in$*$$j&_#wr)'
...
ROOT_URLCONF = 'DjangoRecipesRank.urls'
...
WSGI_APPLICATION = 'DjangoRecipesRank.wsgi.application'
